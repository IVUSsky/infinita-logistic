...
exports.create = (req, res) => {
  ...
  db.get('shipments').push({
    ...
    // Транспорт
    freight_forwarder: d.freight_forwarder || null,
    courier_id: d.courier_id || null,
    transport_type: d.transport_type || null,
    // Дати
    readiness_date: d.readiness_date || null,
    ...
    insurance_cost_currency: d.insurance_cost_currency || 'EUR',
    total_cost: d.total_cost || null,
    total_cost_currency: d.total_cost_currency || 'EUR',
    invoice_number: d.invoice_number || null,
    invoice_value: d.invoice_value || null,
    invoice_value_currency: d.invoice_value_currency || 'EUR',
    po_number: d.po_number || null,
    notes: d.notes || null,
    expected_vat: d.expected_vat || null,
    expected_vat_currency: d.expected_vat_currency || 'EUR',
    actual_vat: d.actual_vat || null,
    actual_vat_currency: d.actual_vat_currency || 'EUR',
    actual_customs_duty: d.actual_customs_duty || null,
    actual_customs_duty_currency: d.actual_customs_duty_currency || 'EUR',
